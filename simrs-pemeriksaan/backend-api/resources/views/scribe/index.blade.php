    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="eresep">
                    <a href="#eresep">EResep</a>
                                ...
                                <a href="#eresep-GETapi-e-resep">Ambil daftar resep beserta detailnya.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="eresep-POSTapi-e-resep">
                                <a href="#eresep-POSTapi-e-resep">Tambah resep baru.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="eresep-GETapi-e-resep--id-">
                                <a href="#eresep-GETapi-e-resep--id-">Ambil satu resep beserta detailnya.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="eresep-PUTapi-e-resep--id-">
                                <a href="#eresep-PUTapi-e-resep--id-">Update data resep.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="eresep-DELETEapi-e-resep--id-">
                                <a href="#eresep-DELETEapi-e-resep--id-">Hapus resep tertentu.</a>
                            </li>
                                                                        </ul>
                            </ul>
                ...
                <li class="tocify-item level-1" data-unique="endpoints">
                    <a href="#endpoints">Endpoints</a>
                                ...
                                <a href="#endpoints-POSTapi-logout">POST api/logout</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-e-resepdetail">
                                <a href="#endpoints-GETapi-e-resepdetail">Tampilkan daftar detail resep dengan pagination</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-e-resepdetail">
                                <a href="#endpoints-POSTapi-e-resepdetail">Simpan detail resep baru</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-e-resepdetail--id-">
                                <a href="#endpoints-GETapi-e-resepdetail--id-">Tampilkan satu detail resep</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-PUTapi-e-resepdetail--id-">
                                <a href="#endpoints-PUTapi-e-resepdetail--id-">Update detail resep</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-DELETEapi-e-resepdetail--id-">
                                <a href="#endpoints-DELETEapi-e-resepdetail--id-">Hapus detail resep</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-test-data--no_registrasi-">
                                <a href="#endpoints-GETapi-test-data--no_registrasi-">GET api/test-data/{no_registrasi}</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-test-pemeriksaan--no_registrasi-">
                                <a href="#endpoints-GETapi-test-pemeriksaan--no_registrasi-">GET api/test-pemeriksaan/{no_registrasi}</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-test-pemeriksaan">
                                <a href="#endpoints-GETapi-test-pemeriksaan">GET api/test-pemeriksaan</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-test-tables">
                                <a href="#endpoints-GETapi-test-tables">GET api/test-tables</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-pemeriksaan">
                                <a href="#endpoints-POSTapi-pemeriksaan">POST api/pemeriksaan</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-pemeriksaan--no_registrasi-">
                                <a href="#endpoints-GETapi-pemeriksaan--no_registrasi-">GET api/pemeriksaan/{no_registrasi}</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-PUTapi-pemeriksaan--no_registrasi--diagnosa">
                                <a href="#endpoints-PUTapi-pemeriksaan--no_registrasi--diagnosa">PUT api/pemeriksaan/{no_registrasi}/diagnosa</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-status--noReg--current">
                                <a href="#endpoints-GETapi-status--noReg--current">GET api/status/{noReg}/current</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-status--noReg--history">
                                <a href="#endpoints-GETapi-status--noReg--history">GET api/status/{noReg}/history</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-status">
                                <a href="#endpoints-POSTapi-status">POST api/status</a>
                            </li>
                                                                        </ul>
                            </ul>
...
<p>This API is not authenticated.</p>
        ...
        <h1 id="eresep">EResep</h1>
                                ...
                                <h2 id="eresep-GETapi-e-resep">Ambil daftar resep beserta detailnya.</h2>
...
<div class="bash-example">
    ...
    --get "http://localhost:8000/api/e-resep" \
...
<div class="javascript-example">
    ...
    "http://localhost:8000/api/e-resep"
);
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="eresep-POSTapi-e-resep">Tambah resep baru.</h2>
...
<p>Nomor registrasi pasien. Example: <code>12345</code></p>
                    ...
                    <h2 id="eresep-GETapi-e-resep--id-">Ambil satu resep beserta detailnya.</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8000/api/e-resep/16" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost:8000/api/e-resep/16"
);
...
<p>The ID of the e resep. Example: <code>16</code></p>
                    ...
                    <h2 id="eresep-PUTapi-e-resep--id-">Update data resep.</h2>
...
<p>Nomor registrasi pasien. Example: <code>12345</code></p>
                    ...
                    <h2 id="eresep-DELETEapi-e-resep--id-">Hapus resep tertentu.</h2>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-GETapi-e-resepdetail">Tampilkan daftar detail resep dengan pagination</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8000/api/e-resepdetail" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost:8000/api/e-resepdetail"
);
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-e-resepdetail">Simpan detail resep baru</h2>
...
<p>Example: <code>architecto</code></p>
                    ...
                    <h2 id="endpoints-GETapi-e-resepdetail--id-">Tampilkan satu detail resep</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8000/api/e-resepdetail/16" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost:8000/api/e-resepdetail/16"
);
...
<p>The ID of the e resepdetail. Example: <code>16</code></p>
                    ...
                    <h2 id="endpoints-PUTapi-e-resepdetail--id-">Update detail resep</h2>
...
<p>Example: <code>architecto</code></p>
                    ...
                    <h2 id="endpoints-DELETEapi-e-resepdetail--id-">Hapus detail resep</h2>
...
<p>The ID of the e resepdetail. Example: <code>16</code></p>
                    ...
                    <h2 id="endpoints-GETapi-test-data--no_registrasi-">GET api/test-data/{no_registrasi}</h2>
...
<span id="example-requests-GETapi-test-data--no_registrasi-">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8000/api/test-data/architecto" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost:8000/api/test-data/architecto"
);
...
<span id="example-responses-GETapi-test-data--no_registrasi-">
            <blockquote>
            <p>Example response (401):</p>
        </blockquote>
                <details class="annotation">
...
<span id="execution-results-GETapi-test-data--no_registrasi-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-test-data--no_registrasi-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-test-data--no_registrasi-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-test-data--no_registrasi-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-test-data--no_registrasi-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-test-data--no_registrasi-" data-method="GET"
      data-path="api/test-data/{no_registrasi}"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-test-data--no_registrasi-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-test-data--no_registrasi-"
                    onclick="tryItOut('GETapi-test-data--no_registrasi-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-test-data--no_registrasi-"
                    onclick="cancelTryOut('GETapi-test-data--no_registrasi-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-test-data--no_registrasi-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/test-data/{no_registrasi}</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-test-data--no_registrasi-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-test-data--no_registrasi-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="no_registrasi"                data-endpoint="GETapi-test-data--no_registrasi-"
               value="architecto"
               data-component="url">
    <br>
<p>Example: <code>architecto</code></p>
                    ...
                    <h2 id="endpoints-GETapi-test-pemeriksaan--no_registrasi-">GET api/test-pemeriksaan/{no_registrasi}</h2>
...
<span id="example-requests-GETapi-test-pemeriksaan--no_registrasi-">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8000/api/test-pemeriksaan/architecto" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost:8000/api/test-pemeriksaan/architecto"
);
...
<span id="example-responses-GETapi-test-pemeriksaan--no_registrasi-">
            <blockquote>
            <p>Example response (401):</p>
        </blockquote>
                <details class="annotation">
...
<span id="execution-results-GETapi-test-pemeriksaan--no_registrasi-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-test-pemeriksaan--no_registrasi-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-test-pemeriksaan--no_registrasi-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-test-pemeriksaan--no_registrasi-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-test-pemeriksaan--no_registrasi-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-test-pemeriksaan--no_registrasi-" data-method="GET"
      data-path="api/test-pemeriksaan/{no_registrasi}"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-test-pemeriksaan--no_registrasi-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-test-pemeriksaan--no_registrasi-"
                    onclick="tryItOut('GETapi-test-pemeriksaan--no_registrasi-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-test-pemeriksaan--no_registrasi-"
                    onclick="cancelTryOut('GETapi-test-pemeriksaan--no_registrasi-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-test-pemeriksaan--no_registrasi-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/test-pemeriksaan/{no_registrasi}</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-test-pemeriksaan--no_registrasi-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-test-pemeriksaan--no_registrasi-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="no_registrasi"                data-endpoint="GETapi-test-pemeriksaan--no_registrasi-"
               value="architecto"
               data-component="url">
    <br>
<p>Example: <code>architecto</code></p>
                    ...
                    <h2 id="endpoints-GETapi-test-pemeriksaan">GET api/test-pemeriksaan</h2>
...
<span id="example-requests-GETapi-test-pemeriksaan">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8000/api/test-pemeriksaan" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost:8000/api/test-pemeriksaan"
);
...
<span id="example-responses-GETapi-test-pemeriksaan">
            <blockquote>
            <p>Example response (401):</p>
        </blockquote>
                <details class="annotation">
...
<span id="execution-results-GETapi-test-pemeriksaan" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-test-pemeriksaan"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-test-pemeriksaan"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-test-pemeriksaan" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-test-pemeriksaan">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-test-pemeriksaan" data-method="GET"
      data-path="api/test-pemeriksaan"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-test-pemeriksaan', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-test-pemeriksaan"
                    onclick="tryItOut('GETapi-test-pemeriksaan');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-test-pemeriksaan"
                    onclick="cancelTryOut('GETapi-test-pemeriksaan');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-test-pemeriksaan"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/test-pemeriksaan</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-test-pemeriksaan"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-test-pemeriksaan"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-GETapi-test-tables">GET api/test-tables</h2>
...
<span id="example-requests-GETapi-test-tables">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8000/api/test-tables" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost:8000/api/test-tables"
);
...
<span id="example-responses-GETapi-test-tables">
            <blockquote>
            <p>Example response (401):</p>
        </blockquote>
                <details class="annotation">
...
<span id="execution-results-GETapi-test-tables" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-test-tables"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-test-tables"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-test-tables" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-test-tables">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-test-tables" data-method="GET"
      data-path="api/test-tables"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-test-tables', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-test-tables"
                    onclick="tryItOut('GETapi-test-tables');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-test-tables"
                    onclick="cancelTryOut('GETapi-test-tables');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-test-tables"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-test-tables"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-test-tables"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-pemeriksaan">POST api/pemeriksaan</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "http://localhost:8000/api/pemeriksaan" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-GETapi-pemeriksaan--no_registrasi-">GET api/pemeriksaan/{no_registrasi}</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8000/api/pemeriksaan/architecto" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost:8000/api/pemeriksaan/architecto"
);
...
<p>Example: <code>architecto</code></p>
                    ...
                    <h2 id="endpoints-PUTapi-pemeriksaan--no_registrasi--diagnosa">PUT api/pemeriksaan/{no_registrasi}/diagnosa</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request PUT \
    "http://localhost:8000/api/pemeriksaan/architecto/diagnosa" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<p>Example: <code>architecto</code></p>
                    ...
                    <h2 id="endpoints-GETapi-status--noReg--current">GET api/status/{noReg}/current</h2>
...
<span id="example-requests-GETapi-status--noReg--current">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8000/api/status/architecto/current" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost:8000/api/status/architecto/current"
);
...
<span id="example-responses-GETapi-status--noReg--current">
            <blockquote>
            <p>Example response (401):</p>
        </blockquote>
                <details class="annotation">
...
<span id="execution-results-GETapi-status--noReg--current" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-status--noReg--current"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-status--noReg--current"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-status--noReg--current" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-status--noReg--current">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-status--noReg--current" data-method="GET"
      data-path="api/status/{noReg}/current"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-status--noReg--current', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-status--noReg--current"
                    onclick="tryItOut('GETapi-status--noReg--current');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-status--noReg--current"
                    onclick="cancelTryOut('GETapi-status--noReg--current');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-status--noReg--current"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/status/{noReg}/current</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-status--noReg--current"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-status--noReg--current"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
                        ...
                        <h4 class="fancy-heading-panel"><b>URL Parameters</b></h4>
                    <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>noReg</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="noReg"                data-endpoint="GETapi-status--noReg--current"
               value="architecto"
               data-component="url">
    <br>
<p>Example: <code>architecto</code></p>
                    ...
                    <h2 id="endpoints-GETapi-status--noReg--history">GET api/status/{noReg}/history</h2>
...
<span id="example-requests-GETapi-status--noReg--history">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8000/api/status/architecto/history" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost:8000/api/status/architecto/history"
);
...
<span id="example-responses-GETapi-status--noReg--history">
            <blockquote>
            <p>Example response (401):</p>
        </blockquote>
                <details class="annotation">
...
<span id="execution-results-GETapi-status--noReg--history" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-status--noReg--history"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-status--noReg--history"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-status--noReg--history" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-status--noReg--history">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-status--noReg--history" data-method="GET"
      data-path="api/status/{noReg}/history"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-status--noReg--history', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-status--noReg--history"
                    onclick="tryItOut('GETapi-status--noReg--history');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-status--noReg--history"
                    onclick="cancelTryOut('GETapi-status--noReg--history');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-status--noReg--history"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/status/{noReg}/history</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-status--noReg--history"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-status--noReg--history"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="noReg"                data-endpoint="GETapi-status--noReg--history"
               value="architecto"
               data-component="url">
    <br>
<p>Example: <code>architecto</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-status">POST api/status</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8000/api/jadwal-dokter" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
